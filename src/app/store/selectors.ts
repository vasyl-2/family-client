...
export const chaptersSelector = createSelector(
  gallerySelector,
  (state: GalleryState) => state.chapters,
);
export const chaptersHierarchySelector = createSelector(
  gallerySelector,
...
export const isAuthenticated = createSelector(
  gallerySelector,
  (state: GalleryState) => state.auth.authenticated,
);

export const usersSelector = createSelector(
  gallerySelector,
  (state: GalleryState) => state.admin.users,
);
export const rolesSelector = createSelector(
  gallerySelector,
  (state: GalleryState) => state.admin.roles,
);
export const permissionsSelector = createSelector(
  gallerySelector,
  (state: GalleryState) => state.admin.permissions,
);

export const permissionsForUserLoaded = createSelector(
  gallerySelector,
  (state: GalleryState) => state.auth.permissionsLoaded,
);
